...
location3 = (45.4795202, -73.57696529999998) # Atwater
...
distanceMatrix1 = gmaps.distance_matrix(location1, midpoint)
duration1 = distanceMatrix1['rows'][0]['elements'][0]['duration']['value'] # time in seconds

def moveMidpoint(location, midpoint, average, duration):
    # calculate direction from midpoint to location
    return(0,0)
